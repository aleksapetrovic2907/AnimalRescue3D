...
namespace Aezakmi.AchievementSystem
{
    ...
    public partial class AchievementsManager
    {
        ...
        public void LoadAchievements()
        {
            ...
            // Regions unlocked
            achievements.Add(new Achievement("Passenger", "Travel to 2 regions.", (object o) => GameDataManager.Instance.gameData.totalMoney >= 2000f, delegate { return Mathf.Clamp(GameDataManager.Instance.gameData.totalMoney / 2000f, 0, 1); }, 2, achievementSprites[13]));
            achievements.Add(new Achievement("Tourist", "Travel to 3 regions.", (object o) => GameDataManager.Instance.gameData.totalMoney >= 25000f, delegate { return Mathf.Clamp(GameDataManager.Instance.gameData.totalMoney / 25000f, 0, 1); }, 5, achievementSprites[14]));
            achievements.Add(new Achievement("Globetrotter", "Travel to 4 regions.", (object o) => GameDataManager.Instance.gameData.totalMoney >= 100000f, delegate { return Mathf.Clamp(GameDataManager.Instance.gameData.totalMoney / 100000f, 0, 1); }, 10, achievementSprites[15]));
